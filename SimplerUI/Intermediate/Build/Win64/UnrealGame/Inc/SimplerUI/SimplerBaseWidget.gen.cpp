...
// End Cross Module References
...
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp__widgetToActivate_MetaData[];
#endif
		static const UECodeGen_Private::FObjectPropertyParams NewProp__widgetToActivate;
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_USimplerBaseWidget_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_USimplerBaseWidget_RemoveWidgetFromBase, "RemoveWidgetFromBase" }, // 2096670887
	};
#if WITH_METADATA
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_USimplerBaseWidget_Statics::NewProp__widgetToActivate_MetaData[] = {
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "Public/HUD/SimplerBaseWidget.h" },
	};
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_USimplerBaseWidget_Statics::NewProp__widgetToActivate = { "_widgetToActivate", nullptr, (EPropertyFlags)0x0040000000080008, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(USimplerBaseWidget, _widgetToActivate), Z_Construct_UClass_USimplerActivatableWidget_NoRegister, METADATA_PARAMS(Z_Construct_UClass_USimplerBaseWidget_Statics::NewProp__widgetToActivate_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_USimplerBaseWidget_Statics::NewProp__widgetToActivate_MetaData)) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_USimplerBaseWidget_Statics::PropPointers[] = {
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_USimplerBaseWidget_Statics::NewProp__widgetToActivate,
	};
	...
	struct Z_CompiledInDeferFile_FID_HistoricalFigures_Plugins_SimplerUI_Source_SimplerUI_Public_HUD_SimplerBaseWidget_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HistoricalFigures_Plugins_SimplerUI_Source_SimplerUI_Public_HUD_SimplerBaseWidget_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_USimplerBaseWidget, USimplerBaseWidget::StaticClass, TEXT("USimplerBaseWidget"), &Z_Registration_Info_UClass_USimplerBaseWidget, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USimplerBaseWidget), 3674297752U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HistoricalFigures_Plugins_SimplerUI_Source_SimplerUI_Public_HUD_SimplerBaseWidget_h_1814163288(TEXT("/Script/SimplerUI"),
		Z_CompiledInDeferFile_FID_HistoricalFigures_Plugins_SimplerUI_Source_SimplerUI_Public_HUD_SimplerBaseWidget_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_HistoricalFigures_Plugins_SimplerUI_Source_SimplerUI_Public_HUD_SimplerBaseWidget_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
